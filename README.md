# Sova Coding Intermediate JavaScript Curriculum

## Overview
This curriculum is designed for intermediate learners of JavaScript programming, gradually introducing concepts across 6 lessons.  
It includes **practice problems**, **examples**, and **homework** to reinforce learning.

The lessons cover:  
1. Review of beginner JavaScript
2. Strings (indexing, functions, shortcuts, algorithms, building)
3. Advanced `for` loops, nested loops, and 2D arrays
4. Objects
5. Arrays of objects and sorting
6. More functions
...
3. This will launch a ready-to-use online development environment in your browser, with Node.js pre-installed.  
